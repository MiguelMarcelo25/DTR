...
import { Form, DateField, TextField } from '@/components/ui/form';
...
export default function ProcessPayrollPage() {
  ...
  const readinessPeriod = startDate ? periodFromDate(startDate) : null;
    ...
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,42rem)_minmax(20rem,1fr)]">
        ...
        <PeriodReadinessPanel
          year={readinessPeriod?.year}
          month={readinessPeriod?.month}
          title="Payroll Readiness"
          description="Attendance period checks for the selected start month."
